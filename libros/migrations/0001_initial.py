# Generated by Django 5.2.10 on 2026-02-18 02:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descripcion', models.TextField(blank=True)),
                ('estado', models.CharField(choices=[('disponible', 'Disponible'), ('prestado', 'Prestado'), ('reservado', 'Reservado'), ('mantenimiento', 'En Mantenimiento')], default='disponible', max_length=20)),
                ('stock_total', models.IntegerField(default=1)),
                ('stock_disponible', models.IntegerField(default=1)),
                ('ubicacion_fisica', models.CharField(blank=True, help_text='Ej: Estante A-12', max_length=50)),
                ...
                ('editorial', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='libros', to='libros.editorial')),
            ],
            options={
                'verbose_name': 'Libro',
