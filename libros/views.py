...
from rest_framework import viewsets, filters, permissions # <--- Asegúrate de que esté 'permissions'
from rest_framework.permissions import IsAuthenticatedOrReadOnly, AllowAny # <--- O impórtalo directamente
